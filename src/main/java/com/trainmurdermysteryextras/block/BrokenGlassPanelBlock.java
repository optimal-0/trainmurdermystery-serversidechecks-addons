...
public class BrokenGlassPanelBlock extends FacingBlock {
    ...
    public static final VoxelShape NO_SHAPE = Block.createCuboidShape(0, 0, 0, 0, 0, 0);
    ...
    public boolean isSideInvisible(BlockState state, BlockState stateFrom, Direction direction) {
        ...
        boolean isVariantPanel = stateFrom.isOf(this)
                || stateFrom.isOf(TMMEBlocks.GOLDEN_GLASS_PANEL_LOWER)
                || stateFrom.isOf(TMMEBlocks.GOLDEN_GLASS_PANEL_UPPER)
                || stateFrom.isOf(TMMEBlocks.GOLDEN_GLASS_PANEL_TOP)
                || stateFrom.isOf(TMMEBlocks.GOLDEN_GLASS_PANEL_BOTTOM)
                || stateFrom.isOf(TMMEBlocks.GOLDEN_GLASS_PANEL_RIGHT)
                || stateFrom.isOf(TMMEBlocks.GOLDEN_GLASS_PANEL_LEFT)
                || stateFrom.isOf(TMMEBlocks.GOLDEN_GLASS_PANEL_TOP_RIGHT)
